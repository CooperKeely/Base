...
#define COLOR_MAGENTA (ColorRGBA){.r=255, .g=0, .b=255,  .a=255}
#define COLOR_CYAN (ColorRGBA){.r=0, .g=255, .b=255,  .a=255}
...
void triangle_draw_test(WM_Context ctx){
	...
	wm_draw_triangle(&ctx, (Vec2U32){100, 100}, (Vec2U32){100, 100}, (Vec2U32){100, 100}, COLOR_RED); 

	// 2. Degenerate Case: A Flat Line
	// Three collinear points. Should look like a single horizontal line.
	wm_draw_triangle(&ctx, (Vec2U32){10, 10}, (Vec2U32){50, 10}, (Vec2U32){100, 10}, COLOR_GREEN);

	// 3. Standard Case: Right-angled Triangle
	// Perfect for checking if the fill/lines align on axes.
	wm_draw_triangle(&ctx, (Vec2U32){200, 200}, (Vec2U32){200, 300}, (Vec2U32){300, 300}, COLOR_BLUE);

	// 4. "The Needle": Very thin triangle
	// Tests the precision of your Bresenham/Rasterizer logic.
	wm_draw_triangle(&ctx, (Vec2U32){400, 100}, (Vec2U32){405, 100}, (Vec2U32){600, 500}, COLOR_YELLOW);

	// 5. Clipping Case: Partially off-screen (Left/Top)
	// One or more vertices have coordinates near or at 0.
	wm_draw_triangle(&ctx, (Vec2U32){-10, -10}, (Vec2U32){50, 10}, (Vec2U32){10, 50}, COLOR_MAGENTA);
	...
	wm_draw_triangle(&ctx, (Vec2U32){w-20, h-20}, (Vec2U32){w+50, h-20}, (Vec2U32){w-20, h+50}, COLOR_CYAN);
	...
	wm_draw_triangle(&ctx, (Vec2U32){500, 500}, (Vec2U32){550, 600}, (Vec2U32){450, 600}, COLOR_WHITE);
